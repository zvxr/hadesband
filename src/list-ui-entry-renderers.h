 ...
 * and equippable comparison is drawn.  There's fuller descriptions of these
 * renderers in ui_entry_renderer.txt.
 */

/* symbol, default colors, default label colors, default symbols,
   default number of digits, sign indicator handling */
UI_ENTRY_RENDERER(COMPACT_RESIST_RENDERER_WITH_COMBINED_AUX, "RESIST_0", "wwwwwwGGGrrGGGwGrGwwrwWWWWWWGGGrrGGGWGrGWWrW", "swBrgwBrwBwBr", "?..+-*!^.=.%%%~!=%~+=~", 0, NO_SIGN)
UI_ENTRY_RENDERER(COMPACT_FLAG_RENDERER_WITH_COMBINED_AUX, "LOGICAL_OR", "wwwwGWWWWG", "swBw", "?..+!", 0, NO_SIGN)
UI_ENTRY_RENDERER(COMPACT_TIERED_FLAG_RENDERER_WITH_COMBINED_AUX, "LARGEST", "wwwGGWwwwGGW", "swBGG", "?..+*!", 0, NO_SIGN)
