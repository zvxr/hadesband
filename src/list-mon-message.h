...
MON_MSG(MORE_NAUSEATED,		MSG_GENERIC,	false,	"look[s] more nauseated.")
MON_MSG(NAUSEATED,			MSG_GENERIC,	false,	"look[s] nauseated.")
MON_MSG(NOT_NAUSEATED,		MSG_GENERIC,	false,	"[is|are] no longer nauseated.")
MON_MSG(MORE_DROWNING,		MSG_GENERIC,	false,	"choke[s] on the water.")
MON_MSG(DROWNING,			MSG_GENERIC,	false,	"start[s] drowning.")
MON_MSG(NOT_DROWNING,		MSG_GENERIC,	false,	"can breathe again.")
MON_MSG(FLOP_GROUND,		MSG_GENERIC,	false,	"flop[s] violently on the ground!")
MON_MSG(FLOP_DIE,			MSG_KILL,		false,	"die[s] gasping!")
