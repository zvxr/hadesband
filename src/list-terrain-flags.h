...
TF(SHOP,       "Is a shop")
TF(DUNGEON_ROOM,"Can spawn as a room in the dungeon")
...
TF(FLY_PASSABLE,"Can be passed through by flying creatures")
TF(ORGANIC,    "Is organic terrain")
TF(CHOPPABLE,  "Can be chopped down")
TF(FLAMMABLE,  "Can burn away")
TF(WATER,      "Is water")
TF(DEEP_WATER, "Is deep water")
