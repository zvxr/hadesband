...
EFFECT(RECHARGE,					false,	"power",	0,		EFINFO_NONE,	"tries to recharge a charged item, destroying the item on failure",	"recharge")
...
EFFECT(MELEE_KNOCKBACK,				true,	"might",	1,		EFINFO_DICE,	"strikes a knockback blow of x%d might against an adjacent monster",	"knockback blow")
