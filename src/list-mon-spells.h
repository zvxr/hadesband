...
RSF(WATER_WHIP,	RST_BOLT | RST_INNATE)
RSF(BLOW_BUBBLES, RST_BOLT)
RSF(SPLASH_ABOUT, RST_ANNOY | RST_INNATE)
RSF(SONIC_CLICK, RST_ANNOY)
RSF(ALGAE_BLOOM, RST_BALL)
