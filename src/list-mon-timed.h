...
MON_TMD(NAUS,	false,	MAX,	RF_NO_NAUS,		50,		MON_MSG_NAUSEATED,		MON_MSG_NOT_NAUSEATED,	MON_MSG_MORE_NAUSEATED)
MON_TMD(DROWNING,false,	MAX,	0,				50,		MON_MSG_DROWNING,		MON_MSG_NOT_DROWNING,	MON_MSG_MORE_DROWNING)
